<x-layoutadmin header="Packs">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 h-full w-full gap-2 mb-10">
        <a href="/admin/packs/create" id="pack-create" class="rounded-md w-72 h-32 hover:cursor-pointer" style="background-image: url('/assets/img/createPack.png')">
            <div class="absolute text-white px-4 pt-5 pb-3 flex flex-col w-72 h-32 justify-between">
                <div class="flex flex-row items-center gap-1">
                    ...
                    <h1 class="font-bold text-xl text-shadow shadow-black">Pack aanmaken.</h1>
                </div>
                <p class="italic text-xs overflow-ellipsis overflow-hidden text-shadow shadow-black">Maak een extra pack aan.</p>
                <div class="text-xs flex flex-row justify-between">
                    <p class="text-shadow shadow-black">Daarna mag je jezelf trakteren op een biertje.</p>
                </div>
            </div>
        </a>
