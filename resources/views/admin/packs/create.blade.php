<x-layoutadmin header="Pack aanmaken">
    <form method="post" action="/admin/packs" enctype="multipart/form-data">
        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <textarea id="description" name="description" rows="3" style="resize: none" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                    </div>
                </div>

                <div class="col-span-full">
                    <label for="cover-photo" class="flex flex-row items-center block text-sm font-medium leading-6 text-gray-900">Cover photo</label>
                        ...
                        <div class="mt-1 space-y-6">
                            <div class="relative flex gap-x-3">
                                <div class="flex h-6 items-center">
                                    <input id="active" name="is_active" checked value="true" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href="/admin/packs" class="text-sm font-semibold w-fit leading-6 text-gray-900">Annuleer</button>
