...
return [
    ...
    */
    ...
    |
    | Two-factor authentication and passkeys are deliberately disabled: the
    | product scope is email/password plus Google OAuth, and shipping auth
    | surface nobody tests is worse than not shipping it.
    |
    */
